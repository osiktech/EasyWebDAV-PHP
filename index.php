    ...
    private function HTML(){
        ...
        <div class="bar">
            ...
            <form method="post" enctype="multipart/form-data" style="margin:0;display:flex;gap:8px">
                ...
                <label class="btn bp" title="<?=T('up_folder')?>" style="padding:10px 14px"><?=$I['up_f']?> <?=T('up_folder')?><input type="file" name="f[]" hidden multiple webkitdirectory mozdirectory onchange="this.form.submit()"></label>
            </form>
